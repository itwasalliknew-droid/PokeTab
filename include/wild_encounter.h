...
struct WildPokemon
{
    ...
    u8 maxLevel;
    u16 species;
    u16 moveOverride; // Custom, attempting to add move overrides for wild encounters
};
...
struct WildEncounterTypes
{
    ...
    const struct WildPokemonInfo *landAltMonsInfo; // custom
};
